...
public class RolForm extends javax.swing.JDialog {
    ...
    rolModel model1 = new rolModel();
    rolDatos datos = new rolDatos();
    ...
    private void initComponents() {
        ...
        txtId.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(41, 43, 45)), "ID", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Sans", 1, 14))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtRol, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
    ...
    private void tblRolesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRolesMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (filaSeleccionada >= 0) {
                ...
                txtRol.setText(datosFila.get(1).toString());
            }
        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (!txtId.getText().equals("")) {
            model.setPK_TBL_PMK_ROL(Integer.parseInt(txtId.getText()));
        } else {
            model.setPK_TBL_PMK_ROL(0);
        }

        model.setROL(txtRol.getText().toUpperCase());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        Object buscar = JOptionPane.showInputDialog(null, "Seleccione una Opcion", "Buscar", JOptionPane.QUESTION_MESSAGE, null, new Object[]{"Seleccione", "Id", "Rol"}, "Seleccione");
        ...
        switch (buscar.toString()) {
            case "Id":
                //Atributos
                model.setPK_TBL_PMK_ROL(Integer.parseInt(valor));
                model.setROL("");
